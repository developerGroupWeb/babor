					...
					<div class="row">
						<div class="col-6 col-md-4 col-xl-3">
							<div class="card mb-4">
								...
								<img src="{{asset('images/imfine.jpg')}}" class="card-img-top" style="height: 160px;">
						...
						<div class="col-6 col-md-4 col-xl-3">
							<div class="card mb-4">
								<img src="{{asset('images/drtt.jpg')}}" class="card-img-top" style="height: 160px;">
								<div class="card-body p-2 bg-white">
									<div class="col-12">
										<div class="row">
						...
						<div class="col-6 col-md-4 col-xl-3">
							<div class="card mb-4">
								<img src="{{asset('images/images.jpg')}}" class="card-img-top" style="height: 160px;">
								<div class="card-body p-2 bg-white">
									<div class="col-12">
										<div class="row">
											<h5 style="color: #737373;">Name</h5>
						...
						<div class="col-6 col-md-4 col-xl-3">
							<div class="card mb-4">
								<img src="{{asset('images/images2.jpg')}}" class="card-img-top" style="height: 160px;">
								<div class="card-body p-2 bg-white">
									<div class="col-12">
										<div class="row">
											<h5 style="color: #737373;">Name</h5>
						...
						<div class="col-6 col-md-4 col-xl-3">
							<div class="card mb-4">
								<img src="{{asset('images/images1.jpg')}}" class="card-img-top" style="height: 160px;">
								<div class="card-body p-2 bg-white">
									<div class="col-12">
										<div class="row">
											<h5 style="color: #737373;">Name</h5>
						...
						<div class="col-6 col-md-4 col-xl-3">
							<div class="card mb-4">
								<img src="{{asset('images/fffff.jpg')}}" class="card-img-top" style="height: 160px;">
								<div class="card-body p-2 bg-white">
									<div class="col-12">
										<div class="row">
											<h5 style="color: #737373;">Name</h5>
						...
						<div class="col-6 col-md-4 col-xl-3">
							<div class="card mb-4">
								<img src="{{asset('images/derr.jpg')}}" class="card-img-top" style="height: 160px;">
								<div class="card-body p-2 bg-white">
									<div class="col-12">
										<div class="row">
											<h5 style="color: #737373;">Name</h5>
